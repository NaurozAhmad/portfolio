...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO users (username, password, type) VALUES (%s, %s, %s)",
...
<td scope="col" colspan="2">Insert User Here..</th></td>
  <tr bgcolor="#FFFFFF">
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><select name="type">
        ...
        <option value="entry" <?php if (!(strcmp("entry", ""))) {echo "SELECTED";} ?>>Entry Operator</option>
      </select></td>
    </tr>
    <tr valign="baseline">
