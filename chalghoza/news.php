...
$all_news = mysql_query($query_all_news, $connection) or die(mysql_error());
...
<p align="center"> <a href="ins_news.php">Insert News here</a></p>
<table width="1024" align="center" border="0" id="a">
<tr bgcolor="#FFFFFF" id="s" >
<td scope="col" colspan="6">All Users are..</th></td>
  <tr bgcolor="#FFFFFF">
  ...
  <?php while ($row_all_news = mysql_fetch_assoc($all_news)) { ?>
    <tr>
      <td><?php echo $row_all_news['n_id']; ?></td>
      <td><?php echo $row_all_news['n_title']; ?></td>
      <td><?php echo date('d-m-Y',strtotime($row_all_news['n_date'])); ?></td>
      <td><?php echo $row_all_news['n_desc']; ?></td>
      <td><a href="del_news.php?did=<?php echo $row_all_news['n_id']; ?>"><img src="images/delete.png" /></a></td>
            <td><a href="upd_news.php?uid=<?php echo $row_all_news['n_id']; ?>"><img src="images/update.png" /></a></td>
