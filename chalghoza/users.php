...
<center>
<p align="center"><a href="ins_users.php">Insert Users Here</a></p>
...
<td scope="col" colspan="6">All Users are..</th></td>
  ...
  <?php $i=1; while ($row_users = mysql_fetch_assoc($users)) { ?>
    <tr>
      ...
      <td><a href="del_users.php?did=<?php echo $row_users['u_id']; ?>"><img src="images/delete.png" /></a></td>
       <td><a href="upd_users.php?uid=<?php echo $row_users['u_id']; ?>"><img src="images/update.png" /></a></td>
