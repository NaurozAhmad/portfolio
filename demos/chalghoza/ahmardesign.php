    ...
    <div class="container_12">
        ...
        <div class="grid_12">
            <ul class="nav main">
				...
				<li class="ic-typography"><a href="typography.html"><span>Admin Panel</span></a></li>
                ...
                <div class="block" id="section-menu">
                    <ul class="section menu">
                        <li><a class="menuitem">Front Page Files</a>
                            <ul class="submenu">
                                <li><a>Users</a> </li>    <li><a href="news.php">News</a> </li> <li><a href="projects.php">Projects</a> </li>
                                                            </ul>
        ...
        <div class="grid_10">
            <div class="box round first">
                ...
                <div class="block">
                    <!-- paragraphs -->
               <center> <script type="text/javascript" src="http://oilprice.com/widgets/flash-clock.js"></script><noscript>Please Enable Javascript for this <a href="http://oilprice.com">Oil Price</a> widget to work</noscript>   </center>
                    <!-- end headings -->
                </div>
            </div>
        </div>
