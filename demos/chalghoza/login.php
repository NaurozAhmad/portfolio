...
$(document).ready(function() {
	$(".username").focus(function() {
		$(".users-icon").css("left","-48px");
	});
	$(".username").blur(function() {
		$(".users-icon").css("left","0px");
	});
...
<!--WRAPPER-->
<a href="index.php"><img src="images/logo.png" width="400" height="200" /></a>
<div id="wrapper">
...
<form name="login-form" class="login-form" action="<?php echo $loginFormAction; ?>" method="POST">
    ...
    <!--FOOTER-->
    <div class="footer">
    <!--LOGIN BUTTON--><input type="submit" name="login" value="Login" class="button" id="login" /><!--END LOGIN BUTTON-->
