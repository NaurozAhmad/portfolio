...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO projects (proj_name) VALUES (%s)",
...
<td scope="col" colspan="2">Insert Projects Here..</th></td>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Project Name</td>
      <td><input type="text" name="proj_name" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
...
<tr bgcolor="#FFFFFF" id="s" >
<td scope="col" colspan="3">All Users are..</th></td>
  <tr bgcolor="#FFFFFF">
    <th scope="col">S.No</th>
     <th scope="col">Project Name</th>
     <th scope="col">Actions</th>
  </tr>
  <?php $i=1; while ($row_projects = mysql_fetch_assoc($projects)) { ?>
    <tr>
      <td><?php echo $i; ?></td>
      <td><?php echo $row_projects['proj_name']; ?></td>
      <td><a href="del_projects.php?did=<?php echo $row_projects['proj_id']; ?>"><img src="images/delete.png" /></a></td>
    </tr>
    <?php $i++; }  ?>
</table>
</center>
