...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO category (cat_name) VALUES (%s)",
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>" id="form">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="text" name="cat_name" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
...
<table border="1">
  ...
  <?php $i=1; while ($row_all_cat = mysql_fetch_assoc($all_cat)) { ?>
  <tr>
    <td><?php echo $i; ?></td>
    <td><?php echo $row_all_cat['cat_name']; ?></td>
    <td><a href="del_category.php?did=<?php echo $row_all_cat['cat_id']; ?>">Delete</a></td>
    <td><a href="upd_category.php?uid=<?php echo $row_all_cat['cat_id']; ?>">Update</a></td>
  </tr>
  <?php $i++;}  ?>
</table>
  </div>
