...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE category SET cat_name=%s WHERE cat_id=%s",
  ...
  $updateGoTo = "category.php?updated";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if(isset($_GET['uid']))
{
	$uid=$_GET['uid'];
mysql_select_db($database_connection, $connection);
$query_upd_cat = "SELECT * FROM category where cat_id=$uid";
$upd_cat = mysql_query($query_upd_cat, $connection) or die(mysql_error());
$row_upd_cat = mysql_fetch_assoc($upd_cat);
$totalRows_upd_cat = mysql_num_rows($upd_cat);
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>" id="form">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="text" name="cat_name" value="<?php echo htmlentities($row_upd_cat['cat_name'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
    </tr>
    <tr valign="baseline">
  ...
  <input type="hidden" name="cat_id" value="<?php echo $row_upd_cat['cat_id']; ?>">
</form>
<p>&nbsp;</p>
