...
<?php 
	if(isset($_GET['uid']))
	{
		...
		$qry=mysql_query("SELECT * FROM `staff` WHERE `staff_id`='$uid'") or die(mysql_error());
	...
	{	
		...
		if($pic!="")
		{
			...
			if($pic=="")
			{
				...
				mysql_query("UPDATE `staff` SET `p_name`='$pic',`staff_name`='$name',`staff_fname`='$fname',`staff_cnic`='$cnic',`staff_regno`='$regno' where `staff_id`='$uid'") or die(mysql_error());
...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="584" height="416" border="1" align="center">
    ...
    <tr>
      ...
      <td><label for="staff_name"></label>
        <input type="text" name="staff_name" id="staff_name" value="<?php echo $prow['staff_name'];?>"></td>
      <td rowspan="4"><p><img src="pics/<?php echo $prow['p_name'];?>" height="199" width="208"/></p></td>
    </tr>
    <tr>
      <td height="38"><p>Father Name</p></td>
      <td height="38"><p>
        <label for="staff_fname"></label>
          <input type="text" name="staff_fname" id="staff_fname" value="<?php echo $prow['staff_fname'];?>">
        </p></td>
    </tr>
    <tr>
      <td height="38"><p>CNIC</p></td>
      <td height="38"><p>
        <label for="staff_cnic"></label>
          <input type="text" name="staff_cnic" id="staff_cnic" value="<?php echo $prow['staff_cnic'];?>">
        </p></td>
    </tr>
    <tr>
      <td height="60"><p>Reg-No</p></td>
      <td height="60"><p>
        <label for="regno"></label>
          <input type="text" name="regno" id="regno" value="<?php echo $prow['staff_regno'];?>">
        </p></td>
    </tr>
    <tr>
      <td colspan="3"><label>
