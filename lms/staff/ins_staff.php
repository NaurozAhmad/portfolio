...
<?php 
$validated_form=array("jpeg","jpg","JPEG","JPG");
	if(isset($_POST['upload']))
	{	
		 $name=$_POST['staff_name'];
		 $fname=$_POST['staff_fname'];
		 $cnic=$_POST['staff_cnic'];
		 $regno=$_POST['staff_regno'];
		...
		if($pic!="")
		{
			if(in_array($ext,$validated_form))
			{
				...
				if(move_uploaded_file($tmp,$dir))
				{
				 ...
				 mysql_query("INSERT INTO `staff` VALUES('','$name','$fname','$cnic','$regno','$pic')") or die(mysql_error());		
...
<div id="contentwrap">
  ...
  <div align="center">
    <tr>
      ...
      <td width="275"><label for="staff_name"></label>
        <input type="text" name="staff_name" id="staff_name"></td>
    </tr>
    <tr>
      <td>Father Name</td>
      <td><label for="staff_fname"></label>
        <input type="text" name="staff_fname" id="staff_fname"></td>
    </tr>
    <tr>
      <td>CNIC</td>
      <td><label for="staff_cnic"></label>
        <input type="text" name="staff_cnic" id="staff_cnic"></td>
    </tr>
    <tr>
      <td>Registeration No</td>
      <td><label for="staff_regno"></label>
        <input type="text" name="staff_regno" id="staff_regno"></td>
    </tr>
