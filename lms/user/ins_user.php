...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO user (username, password, type, staff_id) VALUES (%s, %s, %s, %s)",
...
mysql_select_db($database_connection, $connection);
$query_staff_Data = "SELECT * FROM staff";
$staff_Data = mysql_query($query_staff_Data, $connection) or die(mysql_error());
$row_staff_Data = mysql_fetch_assoc($staff_Data);
$totalRows_staff_Data = mysql_num_rows($staff_Data);
?>
...
<div id="contentwrap">
    ...
    <table align="center">
      ...
      <tr valign="baseline">
        ...
        <td><select name="type">
          <option value="librarian" <?php if (!(strcmp("librarian", ""))) {echo "SELECTED";} ?>>Librarian</option>
...
do {  
?>
          <option value="<?php echo $row_staff_Data['staff_id']?>" ><?php echo $row_staff_Data['staff_name']?></option>
          <?php
} while ($row_staff_Data = mysql_fetch_assoc($staff_Data));
?>
        </select></td>
      <tr>
      <tr valign="baseline">
