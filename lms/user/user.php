...
$query_users_data = "SELECT staff.staff_name,user.* FROM staff,user where staff.staff_id=user.staff_id";
$users_data = mysql_query($query_users_data, $connection) or die(mysql_error());
$row_users_data = mysql_fetch_assoc($users_data);
$totalRows_users_data = mysql_num_rows($users_data);
?>
...
<div id="contentwrap">
    ...
    <div id="data">
   	    <h2>Content Area</h2>
      <a href="ins_user.php">Insert Users Here..</a>
      ...
      <table border="1">
        ...
        <?php $i=1; do { ?>
          <tr>
          	<td><?php echo $i; ?></td>
            <td><?php echo $row_users_data['staff_name']; ?></td>
            <td><?php echo $row_users_data['username']; ?></td>
            <td><?php echo $row_users_data['password']; ?></td>
            <td><?php echo $row_users_data['type']; ?></td>
            <td><a href="../users/upd_users.php?uid=<?php echo $row_users_data['uid']; ?> ">Update</a></td>
            <td><a href="del_user.php?did=<?php echo $row_users_data['uid']; ?>">Delete</a></td>
          </tr>
          <?php $i++;} while ($row_users_data = mysql_fetch_assoc($users_data)); ?>
      </table>
    </div>
